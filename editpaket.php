...
$select_sql = "SELECT * FROM paket WHERE id = $id";
...
if (isset($_POST["Input"])) {
    ...
    if ($gambar != "") {
        ...
        if (in_array($ekstensi, $ektensi_gambar) === true) {
            ...
            $query = "UPDATE paket SET nama_paket = '$nama_paket',harga = '$harga',gambar = '$gambar_baru' ";
            $query .= "WHERE id = '$id'";
        ...
        $query = "UPDATE menu_cafe SET nama_menu = '$nama_menu',harga = '$harga' ";
        $query .= "WHERE id = '$id'";
        $result = mysqli_query($conn, $query);
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="Masukkan Nama Paket" name="nama_paket" required value="<?= $paket["nama_paket"]; ?>"><br><br>
                            <input type="hidden" name="id" value="<?= $paket["id"]; ?>">
                        </div>
                        <div class="input-box">
                            <span class="details">Harga</span>
                            <input type="text" placeholder="Masukkan Harga Paket" name="harga" required value="<?= $paket["harga"]; ?>"><br><br>
                            <input type="hidden" name="id" value="<?= $paket["id"]; ?>">
                        </div>
                        <div class="input-box">
                            <span class="details">Image</span>
                            <img src="gambar/<?= $paket['gambar']; ?>" style="width: 120px; float:left;margin-bottom:5px;">
                    ...
                    <div class="button">
                        ...
                        <center>
                            <p>Kembali ke Halaman <a href="datapelanggan.php">Data Pelanggan </a>
                            <p>
                        </center>
                    </div>
